    ...
    public void initListener() {
        ...
        lv.setOnCreateContextMenuListener(new View.OnCreateContextMenuListener() {
            ...
            public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
                ...
                LUtils.e(ExpenditureQueryActivity.class, "logflag- info.position--" + info.position);
...
//              （从效果图可以看到，菜单的排序是按order的大小排列的！）
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case 0:
                ToastUtils.showToast(ExpenditureQueryActivity.this, "更新");
                return true;
            case 1:
                ToastUtils.showToast(ExpenditureQueryActivity.this, "删除");
                return true;
            default:
